...
class _$NewsStateTearOff {
  ...
  _SuccessNewsState success(List<NewsInformation> newsInformations) {
    return _SuccessNewsState(
      newsInformations,
    );
  }

  _FailureNewsState failure() {
    return const _FailureNewsState();
  }
}
...
mixin _$NewsState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<NewsInformation> newsInformations) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult Function(List<NewsInformation> newsInformations)? success,
...
abstract class _$SuccessNewsStateCopyWith<$Res> {
  ...
  $Res call({List<NewsInformation> newsInformations});
}
...
class _$_SuccessNewsState implements _SuccessNewsState {
  ...
  @override
  final List<NewsInformation> newsInformations;
...
abstract class _SuccessNewsState implements NewsState {
  const factory _SuccessNewsState(List<NewsInformation> newsInformations) =
      _$_SuccessNewsState;

  List<NewsInformation> get newsInformations;
  @JsonKey(ignore: true)
  _$SuccessNewsStateCopyWith<_SuccessNewsState> get copyWith =>
      throw _privateConstructorUsedError;
}
...
class _$_FailureNewsState implements _FailureNewsState {
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _FailureNewsState);
  }
...
abstract class _FailureNewsState implements NewsState {
  const factory _FailureNewsState() = _$_FailureNewsState;
}
